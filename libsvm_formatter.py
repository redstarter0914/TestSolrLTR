...
def _writeRankSVMPairs(listOfFeatures, output):
    ...
    for d1 in range(0, len(listOfFeatures)):
        for d2 in range(d1+1, len(listOfFeatures)):
            ...
            outputLibSvmLine(d1Relevance, fv1, output)
            if d1Relevance - d2Relevance > PAIRWISE_THRESHOLD:
                #d1Relevance > d2Relevance
                ...
                #Must be approximately equal relevance, in which case this is a useless signal and we should skip
                continue
